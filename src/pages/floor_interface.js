const Floor_interface = () => {
    return <div className="row floorInterfaceTab" style={{backgroundColor: 'greenyellow'}} id="body-row">
    <div id="sidebar-container" className=" col-4 side14 hidden">
    ...
    {/* MAIN */}
    <div className="col-8 main14 hidden">
  ...
  export default Floor_interface;