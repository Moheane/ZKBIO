const Ele_contr_level = () => {
    return <div className="row elevatorControlTab" style={{backgroundColor: 'greenyellow'}} id="body-row">
    <div id="sidebar-container" className=" col-4 side2 hidden">
    ...
    {/* MAIN */}
    <div className="col-8 main2 hidden">
  ...
  export default Ele_contr_level;
