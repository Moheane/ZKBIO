...
const Department = () => {
    return <div className="row departmentTab" style={{backgroundColor: 'greenyellow'}} id="body-row">
    <div id="sidebar-container" className=" col-4 side3 hidden">
    ...
    {/* MAIN */}
    <div className="col-8 main3 hidden">
