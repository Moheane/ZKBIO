const Ele_contr_device = () => {
    return  <div className="row elevatorControlDeviceTab" style={{backgroundColor: 'greenyellow'}} id="body-row">
    <div id="sidebar-container" className=" col-4 side5 hidden">
    ...
    {/* MAIN */}
    <div className="col-8 main5 hidden">
  ...
  export default Ele_contr_device;