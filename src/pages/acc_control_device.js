const Access_contr_dev = () => {
    return <div className="row accesControlDeviceTab" style={{backgroundColor: 'greenyellow'}} id="body-row">
    <div id="sidebar-container" className=" col-4 side4 hidden">
    ...
    {/* MAIN */}
    <div className="col-8 main4 hidden">
  ...
  export default Access_contr_dev;